...
IP(0)=0; HG=0;                       call rdft2d(N,N,NY,1,HG,IP,WK)
                                                do NVAR=NBOT,NTOP
                                                            ...
                                                            !ADJUSTED INPUTS SUCH THAT FILE FORMAT IS 000, 001, 002. ETC.
! Create result file
if (NVAR<10) then
    write(NAME,fmt="('Data/results00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/results0',i2)") NVAR
else
    write(NAME,fmt="('Data/results',i3)") NVAR
endif
open(11,file=NAME)
! Create surface file
if (NVAR<10) then
    write(NAME,fmt="('Data/surface00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/surface0',i2)") NVAR
else
    write(NAME,fmt="('Data/surface',i3)") NVAR
endif
open(12,file=NAME)
! Create integra file
if (NVAR<10) then
    write(NAME,fmt="('Data/integra00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/integra0',i2)") NVAR
else
    write(NAME,fmt="('Data/integra',i3)") NVAR
endif
open(13,file=NAME)
! Create spectr file
if (NVAR<10) then
    write(NAME,fmt="('Data/spectr00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/spectr0',i2)") NVAR
else
    write(NAME,fmt="('Data/spectr',i3)") NVAR
endif
open(16,file=NAME)
! Create omega file
if (NVAR<10) then
    write(NAME,fmt="('Data/omega00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/omega0',i2)") NVAR
else
    write(NAME,fmt="('Data/omega',i3)") NVAR
endif
open(23,file=NAME)
! Create rnnli file
if (NVAR<10) then
    write(NAME,fmt="('Data/rnnli00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/rnnli0',i2)") NVAR
else
    write(NAME,fmt="('Data/rnnli',i3)") NVAR
endif
open(25,file=NAME)
! Create rntai file
if (NVAR<10) then
    write(NAME,fmt="('Data/rntai00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/rntai0',i2)") NVAR
else
    write(NAME,fmt="('Data/rntai',i3)") NVAR
endif
open(26,file=NAME)
! Create rbrea file
if (NVAR<10) then
    write(NAME,fmt="('Data/rbrea00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/rbrea0',i2)") NVAR
else
    write(NAME,fmt="('Data/rbrea',i3)") NVAR
endif
open(27,file=NAME)
! Create rinpu file
if (NVAR<10) then
    write(NAME,fmt="('Data/rinpu00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/rinpu0',i2)") NVAR
else
    write(NAME,fmt="('Data/rinpu',i3)") NVAR
endif
open(28,file=NAME)
! Create break file
if (NVAR<10) then
    write(NAME,fmt="('Data/break00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/break0',i2)") NVAR                  
else
    write(NAME,fmt="('Data/break',i3)") NVAR
endif
open(29,file=NAME)
! Create spehx file
if (NVAR<10) then
    write(NAME,fmt="('Data/spehx00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/spehx0',i2)") NVAR
else
    write(NAME,fmt="('Data/spehx',i3)") NVAR
endif
open(30,file=NAME)
! Create sphxx file
if (NVAR<10) then
    write(NAME,fmt="('Data/sphxx00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/sphxx0',i2)") NVAR
else
    write(NAME,fmt="('Data/sphxx',i3)") NVAR
endif
open(31,file=NAME)
! Create rtota file
if (NVAR<10) then
    write(NAME,fmt="('Data/rtota00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/rtota0',i2)") NVAR
else
    write(NAME,fmt="('Data/rtota',i3)") NVAR
endif
open(33,file=NAME)
! Create spfzf file
if (NVAR<10) then
    write(NAME,fmt="('Data/spfzf00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/spfzf0',i2)") NVAR
else
    write(NAME,fmt="('Data/spfzf',i3)") NVAR
endif
open(34,file=NAME)
! Create spwnf file
if (NVAR<10) then
    write(NAME,fmt="('Data/spwnf00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/spwnf0',i2)") NVAR
else
    write(NAME,fmt="('Data/spwnf',i3)") NVAR
endif
open(35,file=NAME)
...
if (DT_VELO>0.) then
    ! Create grid file
    !if (NVAR<10) then
    !    write(NAME,fmt="('Data/grid00',i1)") NVAR
    !else if (NVAR<100) then
    !    write(NAME,fmt="('Data/grid0',i2)") NVAR           
    !else
    !    write(NAME,fmt="('Data/grid',i3)") NVAR
    !endif
    !open(18,file=NAME)
    ! Create Uvelocity file
    if (NVAR<10) then
        write(NAME,fmt="('Data/Uvelocity00',i1)") NVAR
    else if (NVAR<100) then
        write(NAME,fmt="('Data/Uvelocity0',i2)") NVAR
    else
        write(NAME,fmt="('Data/Uvelocity',i3)") NVAR
    endif
    open(19,file=NAME)
    ! Create Vvelocity file
    if (NVAR<10) then
        write(NAME,fmt="('Data/Vvelocity00',i1)") NVAR
    else if (NVAR<100) then
        write(NAME,fmt="('Data/Vvelocity0',i2)") NVAR
    else
        write(NAME,fmt="('Data/Vvelocity',i3)") NVAR
    endif
    open(20,file=NAME)
    ! Create Wvelocity file
    if (NVAR<10) then
        write(NAME,fmt="('Data/Wvelocity00',i1)") NVAR
    else if (NVAR<100) then
        write(NAME,fmt="('Data/Wvelocity0',i2)") NVAR
    else
        write(NAME,fmt="('Data/Wvelocity',i3)") NVAR
    endif
    open(21,file=NAME)
   
    ! Create En_spectr file
    !if (NVAR<10) then
    !    write(NAME,fmt="('Data/En_spectr00',i1)") NVAR
    !else if (NVAR<100) then
    !    write(NAME,fmt="('Data/En_spectr0',i2)") NVAR               
    !else
    !    write(NAME,fmt="('Data/En_spectr',i3)") NVAR
    !endif
    !open(22,file=NAME)
endif
                            if (DT_FIELDS>0) then
!Create fields file                                
if (NVAR<10) then
    write(NAME,fmt="('Data/fields00',i1)") NVAR
else if (NVAR<100) then
    write(NAME,fmt="('Data/fields0',i2)")  NVAR
else 
    write(NAME,fmt="('Data/fields',i3)")  NVAR
endif
open(14,file=NAME);                         endif
! Create restart conditions file
if (NVAR<10) then
    write(NAME_REST,fmt="('Data/restart00',i1)") NVAR
else if (NVAR<100) then
    write(NAME_REST,fmt="('Data/restart0',i2)")  NVAR
else 
    write(NAME_REST,fmt="('Data/restart',i3)")  NVAR
endif
...
!*********************************************Reading restart
	...
	print*,NBOT,NVAR
if (NREST<10) then
    write(NAME,fmt="('Data/restart00',i1)") NREST
else if (NREST<100) then
    write(NAME,fmt="('Data/restart0',i2)")  NREST
else 
    write(NAME,fmt="('Data/restart',i3)")  NREST
endif
...
if (minval(D2HG)<-HXYCR.and.COOL>0.) then
    print *, 'Breaking condition met!'   ! print once
do i=1,N; do j=1,NY; if (D2HG(i,j)<-HXYCR) then; NBR=NBR+1
write(211, '(F10.4, 2I5)') T, i, j
...
enddo !le
                                                           return; end
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$            !EDITS HERE TO ADJUST ORIGINAL SPREADING TO CHANGEABLE COS^JP(THETA) DIRECTIONAL SPREADING
                                                   subroutine PM_JONSWAP
                                                   include 'par.fi'
                                                   include 'com.fi'
real PHAK
real,dimension(M)::SP,BET
real,parameter::EXPM=1.386,BJ=1.25,SI1=.07,       &                          
                SI2=.09,APM=8.14e-3,AJ=.00988,OMIN=.855                 !

SP=0.; ALPHA=AI                                                        !      AI IS DEFIEND IN par.fi file for initial alpha value....
...
SP2=0.; 
!BET=0.; do k=1,NW; RKN=real(k)/real(kp)                         !
...
!enddo; enddo              
!
!THIS IS THE COS ADJUSTMENT INSTEAD                                                     !THIS IS WHERE COS USED INSTEAD......                 
 do k=1,NW; SS=0.; do l=-MY,MY;                                          !
 ARG=ATAN2(real(l),real(k));
 G=cos(ARG)**(JP) 
 SS=SS+G; enddo                          						    ! 
                 do l=-MY,MY;                                           !
 ARG=ATAN2(real(l),real(k));												!
 G=(cos(ARG)**(JP)/SS)
 SP2(k,l)=G*SP(k); AMPL(k,l)=sqrt(2.*SP2(k,l));      					!
 if (SP2(k,l)<1.e-20) SP2(k,l)=1.e-20                                    !
 enddo; enddo   
...
write(12,fmt='(10e12.4)') HG                                                    !ONLY WRITE T AND ACTUAL SURFACE VALUES FOR SURFACE....
...
real,dimension(N,NY)::WG
real,dimension(-M:M,-MY:MY)::WF
WF=HBRX+HBRY                                                                !CHALIKOV NEVER DEFINED HBRX AND HBRY SO ASSUMED WF=HBR (total)
WF = HBR                                                                
call FI(WF,WG,1)
